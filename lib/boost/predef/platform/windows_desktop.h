...
UWP] for Windows Desktop development.  Also available if the Platform SDK is too
old to support UWP.
...
#if BOOST_OS_WINDOWS && ((defined(WINAPI_FAMILY_DESKTOP_APP) &&                \
...
BOOST_PREDEF_DECLARE_TEST(BOOST_PLAT_WINDOWS_DESKTOP,
                          BOOST_PLAT_WINDOWS_DESKTOP_NAME)
