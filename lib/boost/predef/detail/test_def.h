...
void *add_predef_entry(const char *name, const char *description,
                       unsigned value);
...
void *add_predef_entry(const char *name, const char *description,
    ...
    if (0 == generated_predef_info_count) {
        ...
        generated_predef_info_count += 1;
        generated_predef_info = (predef_info *)realloc(
    ...
    generated_predef_info[generated_predef_info_count - 1].description =
        description;
