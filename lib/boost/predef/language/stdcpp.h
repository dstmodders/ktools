...
If available, the year of the standard is detected as YYYY.MM.1 from the Epoch
date. Because of the way the {CPP} standardization process works the defined
