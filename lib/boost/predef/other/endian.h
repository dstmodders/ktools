 ...
 */
    ...
    defined(__MIPSEL__) || defined(__riscv) || defined(__e2k__)
#undef BOOST_ENDIAN_LITTLE_BYTE
#define BOOST_ENDIAN_LITTLE_BYTE BOOST_VERSION_NUMBER_AVAILABLE
#endif
#endif
...
#if BOOST_ARCH_M68K || BOOST_ARCH_PARISC || BOOST_ARCH_SPARC ||                \
    BOOST_ARCH_SYS370 || BOOST_ARCH_SYS390 || BOOST_ARCH_Z
#undef BOOST_ENDIAN_BIG_BYTE
#define BOOST_ENDIAN_BIG_BYTE BOOST_VERSION_NUMBER_AVAILABLE
#endif
...
#include <boost/predef/detail/test.h>
BOOST_PREDEF_DECLARE_TEST(BOOST_ENDIAN_LITTLE_BYTE,
                          BOOST_ENDIAN_LITTLE_BYTE_NAME)

#include <boost/predef/detail/test.h>
BOOST_PREDEF_DECLARE_TEST(BOOST_ENDIAN_LITTLE_WORD,
