...
http://en.wikipedia.org/wiki/The_Portland_Group[Portland Group C/{CPP}]
compiler.
...
#define BOOST_COMP_PGI_DETECTION                                               \
    BOOST_VERSION_NUMBER(__PGIC__, __PGIC_MINOR__, __PGIC_PATCHLEVEL__)
#endif
#if !defined(BOOST_COMP_PGI_DETECTION)
